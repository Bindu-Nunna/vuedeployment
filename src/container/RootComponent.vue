<template>
  <b-container>
    <dialog open v-if="showMenuCard" class="bringFront">
      <menu-items restaurentDetails="restaurentDetails"/>
...
export default {
  ...
  methods: {
    ...
    onDecode(valueDecoded){
      console.log(valueDecoded,'value');
      this.$data.restaurentDetails = valueDecoded;
console.log(this.$data.restaurentDetails,'details');
